...
export const OBSTACLE_DEFINITIONS: Readonly<Record<ObstacleId, ObstacleDefinition>> = {
  "snow-drift": defineObstacle({
    ...
    laneSpan: 1, collisionType: "solid", jumpable: true, visualScale: 0.9,
  ...
  "ice-rock": defineObstacle({
    ...
    laneSpan: 1, collisionType: "solid", jumpable: true, visualScale: 0.95,
  ...
  "ice-hole": defineObstacle({
    ...
    laneSpan: 1, collisionType: "groundHazard", jumpable: true, visualScale: 1,
  ...
  crevasse: defineObstacle({
    ...
    laneSpan: 2, collisionType: "groundHazard", jumpable: true, visualScale: 1,
  ...
  seal: defineObstacle({
    ...
    laneSpan: 2, collisionType: "solid", jumpable: true, visualScale: 1,
